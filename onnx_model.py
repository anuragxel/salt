...
class OnnxModel:
    ...
    def __translate_input(self, image, image_embedding, input_point, input_label, input_box=None, onnx_mask_input=None):
    ...
    def call(self, image, image_embedding, input_point, input_label, selected_box=None, low_res_logits=None):
        ...
        ort_inputs = self.__translate_input(image, image_embedding, input_point, input_label, input_box=input_box, onnx_mask_input=onnx_mask_input)
